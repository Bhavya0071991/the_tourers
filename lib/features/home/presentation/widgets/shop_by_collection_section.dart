...
class _ShopByCollectionSectionState
    extends ConsumerState<ShopByCollectionSection> {
      ...
      data: (collections) {
        ...
        return Container(
          padding: EdgeInsets.symmetric(
            vertical: isDesktop ? AppSizes.p32 : AppSizes.p16,
          ),
...
class _CollectionCard extends StatefulWidget {
  ...
  const _CollectionCard({required this.data, required this.isDesktop});
...
class _CollectionCardState extends State<_CollectionCard> {
  ...
  Widget build(BuildContext context) {
    final primaryColor = Theme.of(context).colorScheme.onSurface;
    final width = widget.isDesktop ? 250.0 : 140.0;
